...
module.exports = function(argv){
    ...
    const baseFilePath = path.join(__dirname, 'templates', 'LIST', `{NAME}List${baseTemplate}{TYPE}Action.js`);
    const destFilePath = path.join(process.cwd(),`${OUT.name}List${baseTemplate}${OUT.upperType}Action.js`);
