...
define([ 'actionType', 'alertStyle', 'webAjax','MessageDialog', 'NCWebActionStyle' ],
        function(actionType, alertStyle, webAjax,MessageDialog, NCWebActionStyle) {
            var CardHead{UPPERTYPE}Action = function(obj) {
                this.serviceProxy;
                this.constantEnum;
            ...
            CardHead{UPPERTYPE}Action.prototype.getCode = function() {
                if (this.actionCode) {
            ...
            CardHead{UPPERTYPE}Action.prototype.getName = function() {
                if (this.actionName) {
            ...
            CardHead{UPPERTYPE}Action.prototype.setPara = function(para) {
                if (this.setParaFunc) {
            ...
            CardHead{UPPERTYPE}Action.prototype.doAction = function(viewModel, cardUtils,
            ...
            CardHead{UPPERTYPE}Action.prototype.isVisible = function(viewModel, cardUtils) {
            ...
            return CardHead{UPPERTYPE}Action;
        });
