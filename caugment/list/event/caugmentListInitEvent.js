...
define(
        [
                'pubListPage',
                ctx
                        + 'modules/party/dwmgr/resource/caugment/list/action/caugmentListPubActions.js',
                ctx
                        + 'modules/party/dwmgr/resource/caugment/list/listener/caugmentSearchBeforeEditListener.js',
            ...
            return {
                init : function(param) {
                    ...
                    var data = { // 业务组初始化卡片页面传参
                        // 业务组初始化卡片页面传参
                        pub : {
                            hid : "pk_caugment",// pk字段
                            form : "#caugment_list_form",// 数据绑定区域
                            billtype : "PT26", // 审批按钮会用，后续不会用到
                        ...
                        list : {
                            ...
                            domid : "dataForm",
                            listBodys : {
                                hid : "pk_caugment",// 主表主键字段
                                tabs : {// 页签编码
                                	arr_caugment_b : {
                                        selected : true,// 默认选中页签，有且只能有一个
                                        tabName : "党委委员增（递）补审批表",// 页签名称
                            ...
                            onDblClickFun : listDblClickEventListener.doListener,
                             dblUrl :
                             "party/dwmgr/resource/caugment/card/caugmentCardUI",
                             // 标准行双击事件跳转路由地址
                             dblType : "detail",
                             dblFuncode : "PTH10206",
                            ...
                            pageData : {// 默认查询条件
                                ...
                                /*
                                 * orders : [ { name : "code", ordertype : 'asc' } ],
                                 */
